...
<body>
    ...
    <section class="site-section py-5" style="background-color:#111d27;">
        <div class="container">
            <h2 class="section-heading">Actresses</h2><br>
            ...
            <div class="row w-100">
                ...
                $totalRecordsSql = "SELECT COUNT(*) as count FROM celebrities WHERE `role` = 'actress'";
                $totalRecordsResult = $conn->query($totalRecordsSql);
                $totalRecords = $totalRecordsResult->fetch_assoc()['count'];

                // Calculate total number of pages
                $totalPages = ceil($totalRecords / $moviesPerPage);

                // Fetch movies for the current page
                $sql = "SELECT * FROM celebrities WHERE `role` = 'actress' LIMIT $offset, $moviesPerPage";
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo '<p class="cardDetails">No movies found.</p>';
                }
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="section-description">
                        ...
                        <br>
                        <p>Your ultimate destination for a cinematic journey! Explore an extensive collection of movies,
                            series, and
                            celebrity insights. Unlock the magic of storytelling with seamless access to information and
                            download
