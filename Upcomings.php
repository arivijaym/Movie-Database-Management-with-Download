...
<body>
    ...
    <section class="site-section py-5" style="background-color:#111d27;">
        <div class="container">
            <h2 class="section-heading">Upcomings - Movies, Series</h2><br>
            ...
            <div class="row w-100">
                ...
                $sql = "SELECT * FROM upcomings LIMIT $offset, $moviesPerPage";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<p class="card-text comingsoon">'.'Comming Soon!'.'</p>';
