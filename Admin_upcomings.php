        ...
        <div class="row">
            ...
            <nav class="col-md-2 d-none d-md-block sidebar">
                <div class="sidebar-sticky">
                    ...
                    <ul class="nav flex-column mb-4">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="Admin_upcomings.php">
                                Upcomings
                            </a>
                        </li>
                        <li class="nav-item">
            ...
            <main role="main" class="col-md-10 ml-sm-auto col-lg-10 px-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Upcomings - Movies & Series</h1>
                </div>

                <div class="row">
                    <form action="AU_add.php" method="post" enctype="multipart/form-data" id="movieForm1">
                        <div class="row">
                            <div class="form-group col-md-3">
                                <label for="moviePoster">Poster</label>
                                <input type="file" class="form-control" id="upcomingPoster" name="upcomingPoster" accept="image/*" required>
                            </div>
                            <div class="form-group col-md-3">
                                <label for="movieName">Name</label>
                                <input type="text" class="form-control" id="upcomingName" name="upcomingName" required>
                            </div>
                            <div class="form-group col-md-3">
                                <label for="movieYear">Year</label>
                                <input type="text" class="form-control" id="upcomingYear" name="upcomingYear" required>
                            </div>
                            <div class="form-group col-md-3">
                                <label for="movieGenre">Genre</label>
                                <input type="text" class="form-control" id="upcomingGenre" name="upcomingGenre" required>
                            </div>
