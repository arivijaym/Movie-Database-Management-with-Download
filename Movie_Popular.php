...
<body>
    ...
    <section class="site-section py-5" style="background-color:#111d27;">
        <div class="container">
            <h2 class="section-heading">Watch the Most Popuulars</h2><br>
            ...
            <div class="row w-100">
                ...
                $sql = "SELECT * FROM movies WHERE popularity_status = 'most_popular' ORDER BY id DESC LIMIT $offset, $moviesPerPage";
