        ...
        <div class="row">
            ...
            <main role="main" class="col-md-10 ml-sm-auto col-lg-10 px-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Movies [New Releases, Most Populars, Upcomings]</h1>
                </div>

                <div class="row">
                    <form action="AM_add.php" method="post" enctype="multipart/form-data" id="movieForm1">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" id="movieQuality" name="movieQuality" required>
                            </div>
                            <div class="form-group col-md-3">
                                <label for="movieRating">Rating</label>
                                <input type="text" class="form-control" id="movieRating" name="movieRating" step="0.1" min="0" max="10" required>
                            </div>
                            <div class="form-group col-md-3">
                                ...
                                <select class="form-control" id="releaseStatus" name="releaseStatus">
                                    ...
                                    <option value="old_movies">Old Release</option>
                                </select>
                            </div>
